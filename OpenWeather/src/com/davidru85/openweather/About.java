...
public class About extends Activity {
	//private ImageButton facebook, twitter, google, linkedin, github;
	private ImageButton twitter, google, linkedin, github;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		github = (ImageButton) findViewById(R.id.profile_github);
	}
	...
	public void profileGithub(View v) {
		Intent browserIntent = new Intent(Intent.ACTION_VIEW,
				Uri.parse(Values.getProfilegithub()));
		startActivity(browserIntent);
	}
}
